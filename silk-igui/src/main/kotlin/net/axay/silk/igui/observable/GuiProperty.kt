 ...
 * the [net.axay.silk.igui.guiIcon] function to specify how the value of this
...
class GuiProperty<T>(private var value: T) {
     ...
     * a [net.axay.silk.igui.GuiIcon] using this property to update. This function is thread-safe.
     *
