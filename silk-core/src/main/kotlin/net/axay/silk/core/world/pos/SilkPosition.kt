...
import net.axay.silk.core.entity.pos
import net.axay.silk.core.serialization.serializers.ResourceLocationSerializer
...
@Deprecated(
    ...
    replaceWith = ReplaceWith("net.axay.silk.core.world.pos.SilkPosition")
)
