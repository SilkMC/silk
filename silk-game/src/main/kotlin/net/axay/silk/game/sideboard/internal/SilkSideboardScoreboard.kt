package net.axay.silk.game.sideboard.internal

import net.axay.silk.core.packet.sendPacket
 ...
 * This implementation is used by the [net.axay.silk.core.sideboard.Sideboard]
 * api.
 *
